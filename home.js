...
(function () {
  ...
  var floatingActionsInited = false;
  function initFloatingActions() {
    if (floatingActionsInited) return;
    const backToTopBtn = document.getElementById('back-to-top');
    const bgAudio = document.getElementById('bg-audio');
    const musicToggleBtn = document.getElementById('music-toggle');

    if (!backToTopBtn && !musicToggleBtn && !bgAudio) return;
    floatingActionsInited = true;
  ...
  /* Initialize floating actions and audio immediately without waiting for fonts */
  initFloatingActions();
